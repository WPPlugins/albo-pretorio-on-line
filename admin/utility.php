...
<div id="utility-tabs-container"  style="margin-top:20px;">
					<ul>
						...
						<li><a href="#utility-tab-3">Post trasferimento sito</a></li>
	...
	case $wpdb->table_name_Atti:
		$Par=array("IdAtto" => array("Tipo" => "int(11)",
					...
					"Data" => array("Tipo" => "date", 
									...
									"Default" => "0000-00-00", 
									"Extra" =>""),
					"Riferimento" => array("Tipo" => "varchar(255)", 
										   "Null" =>"No", 
										   "Key" => "", 
										   "Default" => "", 
										   "Extra" =>""),
					...
					"DataAnnullamento" => array("Tipo" => "date", 
												...
												"Default" => "0000-00-00", 
												"Extra" =>""),
					"MotivoAnnullamento" => array("Tipo" => "varchar(255)", 
												  "Null" =>"YES", 
												  "Key" => "", 
												  "Default" => "", 
												  "Extra" =>""),
...
if(is_file(APHomePath."/robots.txt"))
	...
	$ob3=FALSE;
echo '<div class="wrap">
		<h2 style="font-size:2em;">Analisi Procedura</h2>
